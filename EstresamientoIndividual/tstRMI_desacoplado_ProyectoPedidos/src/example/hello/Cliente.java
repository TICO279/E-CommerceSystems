       ...
       try 
        {
            ...
            //Al final hacemos el cierre
             ...
             sumDeltaT  = 0;
             sumDeltaT2 = 0;
             Hello stub = (Hello) registry.lookup("Hello"); //Aqui es el servicio via la interfaz
             Thread.currentThread().sleep(lngCuantosMilisFaltan);
             
             
             //Por aqui iria el class for name
             for(i= 0; i < n; i++ )
             {
               t0 = System.currentTimeMillis();  
               response = stub.sayHello(); //Lo cambiamos por invoca servicio
