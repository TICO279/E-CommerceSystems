 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://wscredito/}credito" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class FindRangeResponse {
    ...
    protected List<Credito> _return;
     ...
     * 
     */
    public List<Credito> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Credito>();
        }
        return this._return;
    }
